...
def _get_local_target_checked(tyctx, hwstr, reason):
    ...
    # Special case: if both targets are CUDA (even if different classes), allow it
    # if (hwstr == 'cuda' and
    #     target_hw.__class__.__name__ == 'CUDA' and
    #     hw_clazz.__name__ == 'CUDA'):
    #     return target_hw
...
# Registry mapping Target classes to their dispatchers
